      ...
      <div className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-4">
          {tables.map((table) => (
            <div key={table.table} className="flex justify-center">
              ...
              >
                <button
                  onClick={() => handleDeleteTable(table.table)}
                  className="flex items-center justify-center self-start px-4 py-2 gap-3 text-white hover:bg-red-400 bg-red-600 rounded-2xl cursor-pointer ml-3"
                >
                  X
                </button>
                  ...
                  <div className="w-full flex justify-between items-center">
                    <div className="flex gap-3 items-center">
                      <div className="flex gap-3">
                        <button
                          className="flex items-center justify-center self-start w-full sm:w-auto px-4 py-2 gap-3 text-white hover:bg-green-400 bg-green-600 rounded-2xl cursor-pointer"
                          onClick={() => handleOpenTable(table.table)}
                        >
                          Open
                        </button>
                        <button
                          className="flex items-center justify-center self-start w-full sm:w-auto px-4 py-2 gap-3 text-white hover:bg-red-400 bg-red-600 rounded-2xl cursor-pointer"
                      ...
                      {table.callWaiter && (
                        <div onClick={() => handleAttendTable(table.table)} className="p-3 bg-Highlight hover:bg-Highlight/50 rounded-full cursor-pointer flex items-center">
                          <PhoneCall />
                        </div>
                      )}
                    </div>
